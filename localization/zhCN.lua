...
L["options_toggle_show_loot_desc"] = "在提示中加入掉落信息";
L["options_toggle_show_notes"] = "显示注释";
L["options_toggle_show_notes_desc"] = "在提示中添加可用的帮助注释";

--------------------------------- DEVELOPMENT ---------------------------------

L["options_dev_settings"] = "开发";
L["options_dev_settings_desc"] = "开发设置";
L["options_toggle_show_debug"] = "除错";
L["options_toggle_show_debug_desc"] = "显示除错内容";
L["options_toggle_ignore_quests"] = "忽略任务";
L["options_toggle_ignore_quests_desc"] = "忽略项的任务状态";
L["options_toggle_force_nodes"] = "强制项";
